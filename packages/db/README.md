...
Drizzle ORM schemas, migrations, and Supabase-aware client for LocalGem.
...
1. Run `pnpm --filter @localgem/web payload:migrate:create` to generate Payload's migration
